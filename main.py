...
def main():
    ...
    load_1 = Instrucoes("lw", ["$s1", None], ["$s0", 8], 2, 23)
    add_2 = Instrucoes("add", ["$s0", None], ["$s1", None], ["$s3", 2], 1)
    ...
    if(core.init_datapath([add_1, load_1, add_2, sub_1, beq_1, mult_1, add_3, sub_2, sub_3])):
